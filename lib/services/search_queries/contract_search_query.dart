...
class ContractSearchQuery {
  ...
  ContractSearchQuery.BORROWER_ACTIVE_CONTRACTS() : this._(CONTRACT_STATE.ACTIVE_CONTRACT, REQUIREMENT_MODE.REQUESTER);

  ContractSearchQuery.LENDER_ACTIVE_CONTRACTS() : this._(CONTRACT_STATE.ACTIVE_CONTRACT, REQUIREMENT_MODE.LOANER);
