...
class FirestoreService {
  ...
  FirestoreService(
      {this.uid,
      this.value}); // V.I. When we create an instance of this service class, the UID must be passed,
  ...
  final CollectionReference userBillsCollection =
      Firestore.instance.collection('user_bills');
  ...
  Future setOrUpdateUserData(String name, String email, String username,
      String phone, List indexList) async {
  ...
  Future createContract(String requester, String loaner, String dueDate,
      double numPayments, double amount, bool isActive) async {
